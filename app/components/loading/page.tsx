...
//     const tl = gsap.timeline({
//       onComplete: () => {
//         gsap.to([refLoad.current, refCircle.current], {
//           opacity: 0,
//           duration: 0.5,
//           onComplete: onFinish,
//         });
...
//   return (
//     <section className="fixed inset-0 flex items-center justify-center bg-white z-1">
//       <div className="relative flex items-center justify-center ">
//         <div
//             ref={refCircle}
//             className="circle w-40 h-40 border-[6px] rounded-full absolute"
//             style={{
...
//         <div
//             ref={refBox}
//             className="box w-40 h-40 border-[6px] rounded-md absolute"
//             style={{
//               borderTopColor: "#e74c3c",
//               borderRightColor: "#f1c40f",
//               borderBottomColor: "#2ecc71",
